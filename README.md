...
- cell 4 uses 'assignment4-dataset.txt'
- cell 23 uses 'tok_id_embeds.csv' & 'cont_embed_vecs.npy'

# For Problem 2

- cell 17 uses 'tok_id_embeds.csv' & 'cont_embed_vecs.npy'
- cell 21 uses 'glove.6B.300d-vocabulary.txt'
- cell 38 uses 'glove_words_df.csv' & 'glove_avg_word_vecs.npy'
